...
<style>
    ...
    .sd,
    .sd.richText * {
        transition-property: all, var(--g-angle);
        transition-property:
            var(--g-color-0), var(--g-position-0),
            var(--g-color-1), var(--g-position-1),
            var(--g-color-2), var(--g-position-2),
            var(--g-color-3), var(--g-position-3),
            var(--g-color-4), var(--g-position-4),
            var(--g-color-5), var(--g-position-5),
            var(--g-color-6), var(--g-position-6),
            var(--g-color-7), var(--g-position-7),
            var(--g-color-8), var(--g-position-8),
            var(--g-color-9), var(--g-position-9),
            var(--g-color-10), var(--g-position-10),
            var(--g-color-11), var(--g-position-11),
            var(--g-color-12), var(--g-position-12);
    }
...
<style data-v-52f3f575="">
    ...
    .sd[data-s-48c55a3a-3fbb-452b-ab75-81b633308e1e] {
        font-size: 24px;
    }
    ...
    .sd[data-s-00a7011b-345d-4e59-9582-349a31d5ab5e] {
        background: #EEEEEE;
        height: 160px;
        width: 200px;
        max-width: 100%;
    ...
    .sd[data-s-6e807fd3-ba89-47a5-bfaf-19fb4b20b740] {
        font-size: 24px;
    }
...
<style>
    ...
    /* Define variables for colors and positions */
    :root {
        @for ($i = 0; $i <= 13; $i++)
            --g-color-#{$i}: transparent;
            --g-position-#{$i}: 100%;
        @endfor
    }
</style>